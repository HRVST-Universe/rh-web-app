...
module.bundle.HMR_BUNDLE_ID = "c45db529f1b7cdb8";
"use strict";
...
},{}],"e51D0":[function(require,module,exports,__globalThis) {
var $parcel$ReactRefreshHelpers$fabf = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$fabf.prelude(module);
...
var _authForm = require("@/components/AuthForm");
...
var Index = function() {
    ...
    var user = (0, _userContext.useUser)().user;
    // If user is already authenticated, redirect to game
    (0, _reactDefault.default).useEffect(function() {
        if (user === null || user === void 0 ? void 0 : user.isAuthenticated) navigate('/game');
    }, [
        user,
        navigate
    ]);
    ...
    return /*#__PURE__*/ (0, _reactDefault.default).createElement("div", {
        className: "min-h-screen bg-nightsky flex items-center justify-center px-4"
    ...
    }, /*#__PURE__*/ (0, _reactDefault.default).createElement((0, _authFormDefault.default), {
        onSuccess: handleAuthSuccess
    })));
};
_s(Index, "MRbosi84Uk8A8nPxgvwNM2K6Xi8=", false, function() {
    return [
...
$RefreshReg$(_c, "Index");
  ...
  $parcel$ReactRefreshHelpers$fabf.postlude(module);
} finally {
